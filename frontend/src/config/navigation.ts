...
export const navigation: NavItem[] = [
  ...
  // ==================== 5. DMS (Distribution Management) ====================
  {
    ...
    children: [
      ...
      { title: 'Claims', href: '/dashboard/dms/claims', icon: FileOutput, permissions: ['ORDERS_VIEW'] },
      { title: 'Collections', href: '/dashboard/dms/collections', icon: Banknote, permissions: ['ORDERS_VIEW'] },
      { title: 'Retailers', href: '/dashboard/dms/retailers', icon: Store, permissions: ['ORDERS_VIEW'] },
      { title: 'Secondary Sales', href: '/dashboard/dms/secondary-sales', icon: TrendingUp, permissions: ['ORDERS_VIEW'] },
      { title: 'Schemes', href: '/dashboard/dms/schemes', icon: BadgePercent, permissions: ['ORDERS_VIEW'] },
